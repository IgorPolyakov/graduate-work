 ...
 */
struct subSize {
    int x_1;            //!< Координата пикселя по x для левого изображения
    int y_1;            //!< Координата пикселя по y для левого изображения
    int rc;             //!< Радиус окна, т.е. если radiusCode = 2, то сетка 5х5
    int step;           //!< Шаг между векторами
    int x_2;			//!< Координата пикселя по x для правого изображения
    int y_2;			//!< Координата пикселя по у для правого изображения
};
